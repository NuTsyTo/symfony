...
class LoginFormAuthenticator extends AbstractLoginFormAuthenticator
{
    ...
    {
        // Ce bloc de code redirige le user vers la page qu'il avait initialement demandé
        // Si aucune page n'a été demandé, il est redirigé vers une page en fonction de son rôle
